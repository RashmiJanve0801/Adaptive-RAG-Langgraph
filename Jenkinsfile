pipeline {
        ...
        steps {
            script {
                withCredentials([
                    ...
                    sh '''
                    git config user.name "RashmiJanve0801"
    ...
    kubeconfig(credentialsId: 'kubeconfig', serverUrl: 'https://192.168.49.2:8443') {
                sh '''
                    argocd login 34.173.134.149:31704 --username admin --password $(kubectl get secret -n argocd argocd-initial-admin-secret -o jsonpath="{.data.password}" | base64 -d) --insecure
